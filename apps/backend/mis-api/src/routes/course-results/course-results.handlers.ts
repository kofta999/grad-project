...
import { SetResultRoute, DeleteResultRoute, GetCourseResultsRoute } from "./course-results.routes";

const courseResultsService = new CourseResultsService();

export const setCourseResult: AppRouteHandler<SetResultRoute> = async (c) => {
...
export const deleteCourseResult: AppRouteHandler<DeleteResultRoute> = async (c) => {
