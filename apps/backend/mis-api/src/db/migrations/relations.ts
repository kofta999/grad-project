...
import { applications, registerations, emergencyContacts, attachments, addresses, academicQualifications, students, courses, courseResults, departmentCourses, departments } from "./schema";
