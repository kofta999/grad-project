...
import { countries, cities, students, applications, supervisors, registerations, academicYears, departments, attachments, addresses, emergencyContacts, academicQualifications, courses, courseRegistrations, courseResults, theses, departmentCourses } from "./schema";
