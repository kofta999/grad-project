  ...
  const programs = [
    {
      ...
      description:
        "تصميم الفراغات المعمارية والتخطيط الحضري المستدام، مع التركيز على الهوية المحلية والابتكار",
    ...
    },
    {
      ...
      description:
        "دراسة وتطبيق الكهرباء والإلكترونيات والكهرومغناطيسية لتصميم الأنظمة والمعدات الكهربائية.",
      image: "/electric.jpg",
