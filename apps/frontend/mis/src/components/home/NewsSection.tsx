  ...
  const newsItems: NewsItem[] = [
    {
      ...
      date: '2025-03-09',
      description: 'شركة لوريـال تعتزم منحـة سنوية بالاشتراك مع منظمة اليونسكو من خلال برنامج “من أجل المرأة في العلم”',
    ...
    },
    {
      ...
      date: '2025-02-09',
      description: 'نضموا إلينا في معرض Egypt Energy، الحدث الأكبر والأهم للطاقة في شمال إفريقيا، والذي يمتد لأكثر من 33 عامًا من النجاح والريادة في المنطقة.',
    ...
    },
    {
      ...
      date: '2025-12-20',
      description: 'أعلنت هيئة تنمية صناعة تكنولوجيا المعلومات (إيتيدا) عن إطلاق الدورة العشرين من برنامج دعم مشروعات التخرج لطلاب الجامعات، ضمن مبادرة دعم التعاون بين الشركات والجهات البحثية.',
    ...
    <section id="news-section" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-12">
          ...
          <Link href="https://eng.suez.edu.eg/" target='_blank' className="flex items-center text-blue-600 hover:text-blue-800 font-medium">
            عرض جميع الأخبار
            ...
            <div key={news.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center text-gray-500 mb-3">
                  ...
                  <span className="text-sm ml-2">{new Date(news.date).toLocaleDateString('ar-EG')}</span>
                  {news.time && (
                    <>
                ...
                <Link 
                  href={news.link}
                  className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium" target='_blank'
                >
                  اقرأ المزيد
